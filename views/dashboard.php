          ...
          <tbody>
            ...
            while ($user = $all_users->fetch_assoc()) {
                ...
                <tr>
                  ...
                  <td><?=  $user['username']?></td>
                  <td>
                    <a href="edit-user.php?id=<?= $user['id'] ?>" class="btn btn-outline-warning" title="Edit"><i class ="fa-regular fa-pen-to-square"></i></a>
                    <a href="delete-user.php?id=<?= $user['id'] ?>" class="btn btn-outline-danger" title="Edit"><i class ="fa-regular fa-trash-can"></i></a>
                  </td>
                </tr>
            <?php
            }
